...
export default function Addprofile(open) {
  return (
			...
			<div className="mt-5">
				<div className="form">
					<div className="md:space-y-2 mb-3">
						<label className="text-xs font-semibold text-gray-600 py-2">Pet image<abbr className="hidden" title="required">*</abbr></label>
